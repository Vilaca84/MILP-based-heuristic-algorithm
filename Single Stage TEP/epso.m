function [tempo, xopt, fopt, XOPT, FOPT] = epso(tsystem, equipment, inv, Xmax, Xmin, dim, Ntrials, ger, voll, nsol, fhd, betta, stC, r)
...
for T = 1:Ntrials
    ...
    [fitness,pen] = feval(fhd, swarm, tsystem, equipment, voll, inv, betta);
    ...
    while STOP == 0
        ...
        for rep=1:r
            ...
            % Evaluation
            [fitpop{rep},penpop{rep}] = feval(fhd, pop{1,rep}, tsystem, equipment, voll, inv, betta);
        end
